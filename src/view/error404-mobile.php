...
DESIGNED BY: http://salehriaz.com/404Page/404.html

DRIBBBLE: https://dribbble.com/shots/4330167-404-Page-Lost-In-Space
-->

<?php require_once '../routes/dir.php'; ?>s
        ...
        <div class="stars">
            <div class="custom-navbar">
                <div class="brand-logo">
                   <a href="<?= getProjectRoot() ?>home"><img src="<?= getProjectPath() ?>img/logo.png" width="150px"></a>
                </div>
